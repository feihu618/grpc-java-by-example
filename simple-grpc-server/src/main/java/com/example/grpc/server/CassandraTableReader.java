...
/**
  ...
  * stream-reactor
  */
public class CassandraTableReader {

    private static final Logger logger = LoggerFactory.getLogger(CassandraTableReader.class);
...
*/
 ...
 /* private def reset(offset: Option[String]) = {
  ...
  /**
    ...
    */
  public void close() {
    logger.info("Connector $name shutting down queries.");
//    stopQuerying();
    logger.info("Connector $name all stopped.");
  }
